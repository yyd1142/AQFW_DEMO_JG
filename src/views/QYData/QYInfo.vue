    ...
    <div class="page-wrap qy-info-wrap"  v-if="!noData&&!resError">
      ...
      <div class="data-wrap">
        ...
        <mt-cell title="联系电话" :value="dwInfo.dwManagerPhone||'暂无'">
          <a class="phone" :href="'tel:' + dwInfo.dwManagerPhone" v-if="dwInfo.dwManagerPhone">{{dwInfo.dwManagerPhone}}</a>
        </mt-cell>
        ...
        <mt-cell title="联系电话" :value="dwInfo.dwFaRenPhone||'暂无'">
          <a class="phone" :href="'tel:' + dwInfo.dwFaRenPhone" v-if="dwInfo.dwFaRenPhone">{{dwInfo.dwFaRenPhone}}</a>
        </mt-cell>
