<template>
  <div style="margin-bottom: 64px;">
    ...
    <mt-header class="home-header-wrap" :style="{backgroundColor:calcHeadColor(score,headColors)}" fixed title="安全服务云">
      <i class="xiaoxizhongxin-icon" :class="hasMessageDataClass" slot="right" @click="routerLink({url:'/message'})"></i>
    </mt-header>
    <mt-loadmore class="home-load-view"
                 ...
                 :auto-fill="autoFill">
      <div class="page-wrap home-wrap" ref="wrapper" :style="{ height: wrapperHeight + 'px', marginTop: 0 }" v-if="!resError">
        <!--安全得分-->
