<template>
  <div>
    ...
    <mt-header class="header-wrap" :style="{backgroundColor:calcHeadColor(score.totalScore)}" fixed title="社会单位安全评分">
    ...
    <div class="page-wrap score-page-wrap">
      ...
      <div class="data-wrap">
        <div class="total" @click="showDetail.jzhz=!showDetail.jzhz">
          <div class="label">
            <div class="sign-wrap" @click.stop="showScoreDesc('jzhz')"><span class="sign icon-info"></span></div>
            建筑火灾风险评分 (共20分)
          </div>
      ...
      <div class="data-wrap">
        <div class="total" @click="showDetail.xfsssb=!showDetail.xfsssb">
          <div class="label">
            <div class="sign-wrap" @click.stop="showScoreDesc('xfsssb')"><span class="sign icon-info"></span></div>
            消防设施管理评分 (共20分)
          </div>
      ...
      <div class="data-wrap">
        <div class="total" @click="showDetail.xfaqgl=!showDetail.xfaqgl">
          <div class="label">
            <div class="sign-wrap" @click.stop="showScoreDesc('xfaqgl')"><span class="sign icon-info"></span></div>
            消防安全管理得分 (共60分)
          </div>
